...
const Header=()=>{
    ...
    return (
        <div className="absolute w-screen px-10 py-2 bg-gradient-to-b from-black flex justify-between">
            <img className=" w-48 font-extrabold" src="https://cdn.cookielaw.org/logos/dd6b162f-1a32-456a-9cfe-897231c7763c/4345ea78-053c-46d2-b11e-09adaef973dc/Netflix_Logo_PMS.png" alt="logo"></img>
            {user && (
